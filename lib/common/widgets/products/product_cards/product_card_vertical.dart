        ...
        child: Column(
          children: [
            ...
            child: Column(
              ...
              children: [
                const TProductTitleText(title: 'Greeen Nike Air Shoe', smallSize: true),
                const SizedBox(height: TSizes.spaceBtwItems / 2),
                Row(
                  children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Container(
                     ...
                     child: SizedBox(width: TSizes.iconLg * 1.2, height: TSizes.iconLg * 1.2, child: Center(child: Icon(Iconsax.add, color: TColors.white, ))),
                    ),
                  ],
                )
            ],
